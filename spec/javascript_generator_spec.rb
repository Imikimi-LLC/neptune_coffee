...
define([
  ...
  if (typeof File1 == 'function' && !File1.namespace) {Bar.File1 = File1; File1.namespace = Bar;}
  if (typeof File2 == 'function' && !File2.namespace) {Bar.File2 = File2; File2.namespace = Bar;}
  return Bar;
});
ENDJS
  end
